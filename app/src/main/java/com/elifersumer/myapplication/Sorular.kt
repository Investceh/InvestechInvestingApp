...
class Sorular : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        soru2 = findViewById(R.id.soru2) as TextView
        ...
        soru3 = findViewById(R.id.soru3) as TextView
        ...
        soru4 = findViewById(R.id.soru4) as TextView
        ...
        soru5 = findViewById(R.id.soru5) as TextView
        ...
        soru6 = findViewById(R.id.soru6) as TextView
        soru6.text = "Yıllık gelirinizin yüzde kaçını yatırımlarınızda kullanırsınız ?"

        radio_group6 = findViewById(R.id.radio_group6) as RadioGroup

        soru6_sık1 = findViewById(R.id.soru6_sık1) as RadioButton
        soru6_sık1.text = "0-10%"
        soru6_sık2 = findViewById(R.id.soru6_sık2) as RadioButton
        soru6_sık2.text = "10-15%"

        soru6_sık3 = findViewById(R.id.soru6_sık3) as RadioButton
        soru6_sık3.text = "15-20%"
        soru6_sık4 = findViewById(R.id.soru6_sık4) as RadioButton
        soru6_sık4.text = "20-25%"
        soru6_sık5 = findViewById(R.id.soru6_sık5) as RadioButton
        soru6_sık5.text = "+25%"



        soru7 = findViewById(R.id.soru7) as TextView
        soru7.text = "Yatırımınızdan elde edilen getiriyi hangi vadede kullanmak istersiniz ?"

        radio_group7 = findViewById(R.id.radio_group7) as RadioGroup

        soru7_sık1 = findViewById(R.id.soru7_sık1) as RadioButton
        soru7_sık1.text = "10+ yıl"

        soru7_sık2 = findViewById(R.id.soru7_sık2) as RadioButton
        soru7_sık2.text = "7-10 yıl"

        soru7_sık3 = findViewById(R.id.soru7_sık3) as RadioButton
        soru7_sık3.text = "4-7 yıl"

        soru7_sık4 = findViewById(R.id.soru7_sık4) as RadioButton
        soru7_sık4.text = "1-4 yıl"

        soru7_sık5 = findViewById(R.id.soru7_sık5) as RadioButton
        soru7_sık5.text = "0-1 yıl"



        soru8 = findViewById(R.id.soru8) as TextView
        soru8.text = "Hangi hisse senedine yatırım yapmayı tercih edersiniz ?"

        radio_group8 = findViewById(R.id.radio_group8) as RadioGroup

        soru8_sık1 = findViewById(R.id.soru8_sık1) as RadioButton
        soru8_sık1.text = "Yatırımcılarına düzenli kar payı ödeyen köklü bir şirket"

        soru8_sık2 = findViewById(R.id.soru8_sık2) as RadioButton
        soru8_sık2.text = "Büyüme potansiyeli olan tanınmış bir şirket"

        soru8_sık3 = findViewById(R.id.soru8_sık3) as RadioButton
        soru8_sık3.text = "Yeni halka arz edilmiş bir şirket"

        soru8_sık4 = findViewById(R.id.soru8_sık4) as RadioButton
        soru8_sık4.text = "Yeni kurulan bir start-up"

        soru8_sık5 = findViewById(R.id.soru8_sık5) as RadioButton
